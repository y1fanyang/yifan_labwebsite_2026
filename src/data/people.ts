...
export const people: Person[] = [
  ...
  },
  {
    ...
    email: "xujinjian@westlake.edu.cn",
  ...
  },
  {
    ...
    role: "staff",
    roleLabel: "Research Assistant",
    image: "/images/team/minghang-headshot.jpg",
    email: "zhangminghang@westlake.edu.cn",
    bio: "Minghang Zhang is a Research Assistant in the Yang Lab, dedicated to investigating the biology of aging. He received his Bachelor of Science in Biological Sciences from Xiamen University in 2026. While his undergraduate training was primarily grounded in molecular biology, Minghang is actively transitioning toward a more fundamental, systems-level perspective. To pursue a first-principles approach to complex biological questions, he is currently developing expertise in systems biology and quantitative biophysical frameworks. Outside the lab, he enjoys listening to music and staying active through various sports.",
  },
  {
    id: "weirong",
    name: "WeiRong Xiang",
    ...
    email: "xiangweirong@westlake.edu.cn",
